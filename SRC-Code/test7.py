...
def get_network_usage(interval=10):
    ...
    while True:
        ...
        # Control options
        print("\nOptions:")
        print("Press 'k' + Enter → Select a category to kill or reset all")
...
def select_category_to_kill():
    ...
    print("3 → Extras")
    print("4 → System")
    print("5 → Reset All (Kill Everything)")
...
def reset_all_services():
    print("Resetting ALL services (killing everything grouped)...")
    for group_apps in GROUPS.values():
